        ...
        <div class="col-span-12 md:col-span-9">
            <div class="mb-4">
                ...
                <input type="text"
                    ...
                    placeholder="Cth: Toko Parfum Luxuex" required>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text"
                        class="rounded w-full border-gray-300 text-sm  dark:bg-gray-900 dark:border-gray-600 dark:text-white mt-2"
                        name="phone_toko" value="{{ old('phone_toko', $toko->phone_toko ?? '') }}"
                        placeholder="Cth: 08xxxxxxxxxx" required>
                    <span class="text-[0.6rem] text-gold">*Nomor digunakan untuk menerima notifikasi atau kontak keluhan lebih lanjut pengguna</span>
                </div>
            </div>
            <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="link_survey" class="font-semibold text-lg">Link Survey <span
                ...
                <div class="mb-4">
                    <label for="webhook_chatbot" class="font-semibold text-lg">Webhook Chatbot <span
                            class="text-gray-600 text-xs italic">(Opsional)</span></label>
                    <input type="text"
                        class="rounded w-full border-gray-300 text-sm  dark:bg-gray-900 dark:border-gray-600 dark:text-white mt-2"
