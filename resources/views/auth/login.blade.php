<x-guest-layout title="Masuk">
    <div class="flex flex-col items-center justify-center px-6 py-6 mx-auto  font-inter text-white">
        <div
            class="w-full  rounded-lg  shadow-lg border md:mt-0 sm:max-w-md xl:p-0 dark:bg-black/50 dark:backdrop-blur dark:border-gray-700">
