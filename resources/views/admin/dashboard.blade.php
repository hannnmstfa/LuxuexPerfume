<x-app-layout title="Dashboard Admin">
    <div class="grid lg:grid-cols-3 gap-4 dark:text-white relative">
        <div
            class="bg-white dark:bg-black/50 dark:backdrop-blur border dark:border-gray-700 rounded-lg shadow p-4">
            <h2 class="text-xl font-semibold mb-2">Total Penjualan</h2>
            <div class="flex justify-start items-center gap-2">
                <p class="text-3xl font-bold text-yellow-600 dark:text-gold">
                    Rp{{ number_format($trx->sum('total_harga')) }}</p>
                <button data-tooltip-target="penjualan" type="button" data-tooltip-placement="bottom">
        ...
        <div
            class="bg-white dark:bg-black/50 dark:backdrop-blur  border dark:border-gray-700 rounded-lg shadow p-4 relative">
            <h2 class="text-xl font-semibold mb-2">Menunggu Diproses</h2>
            <div class="flex justify-start items-center gap-2">
                <p class="text-3xl font-bold text-yellow-600 dark:text-gold">
                    {{ number_format($menungguProses->count()) }} Transaksi
                </p>
        ...
        <div
            ...
            <div class="flex justify-start items-center gap-2">
                <p class="text-3xl font-bold text-yellow-600 dark:text-gold">{{ number_format($stokHabis->count()) }}
                    Produk</p>
