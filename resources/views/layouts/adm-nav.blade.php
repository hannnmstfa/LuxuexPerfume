<nav class="fixed top-0 z-40 w-full bg-gray-100 border-b border-gray-300 dark:bg-black/70 dark:backdrop-blur dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <button data-drawer-target="adm-sidebar" data-drawer-toggle="adm-sidebar" aria-controls="adm-sidebar"
                    type="button"
