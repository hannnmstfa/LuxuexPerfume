    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            @auth
                ...
                <div class="z-50 hidden bg-gray-200 border border-default-medium rounded-md shadow-lg w-44"
                    ...
                    <ul class="p-2 text-sm text-body font-medium" aria-labelledby="user-menu-button">
                        <li>
                            <a href="#"
                                class="inline-flex items-center w-full p-2 hover:bg-gray-200 rounded">Dashboard</a>
                        </li>
                        <li>
                            <a href="{{ route('profile.edit') }}"
                                class="inline-flex items-center w-full p-2 hover:bg-gray-200 rounded">Settings</a>
                        </li>
                        <li>
                            <a href="#"
                                class="inline-flex items-center w-full p-2 hover:bg-gray-200 rounded">Earnings</a>
                        </li>
                        <li>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                @else
                    <button type="button"
                        class="hidden md:flex text-sm w-max rounded-full md:me-0 focus:ring-2"
                        id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-menu-lg"
                        data-dropdown-placement="bottom">
                        <span class="sr-only">Open user menu</span>
                        <img class="w-20 rounded-full" src="{{ Avatar::create(Auth::user()->name)->toBase64() }}"
                            alt="user photo">
                    </button>
                    <!-- Dropdown menu -->
