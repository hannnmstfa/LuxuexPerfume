<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('admStock.index') }}"
                    class="flex items-center p-2  rounded-lg {{ request()->routeIs('admStock.*') ? 'bg-yellow-800 text-white dark:bg-gray-700' : 'text-gray-900 hover:text-white hover:bg-yellow-800 dark:text-white dark:hover:bg-gray-700 group' }}">
                    <svg class="shrink-0 w-6 h-6 transition duration-75 {{ request()->routeIs('admStock.*') ? 'text-white dark:text-white' : 'text-gray-900 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white' }}"
                    ...
                    <span class="ms-3">Kelola Stok</span>
                </a>
            </li>
            <!-- <li>
                <button type="button"
                    class="flex w-full items-center p-2  rounded-lg {{ request()->routeIs('admProduk.*') ? 'bg-yellow-800 text-white dark:bg-gray-700' : 'text-gray-900 hover:text-white hover:bg-yellow-800 dark:text-white dark:hover:bg-gray-700 group' }}"
                    aria-controls="produk-menu" data-collapse-toggle="produk-menu">
                    <svg class="shrink-0 w-6 h-6 transition duration-75 {{ request()->is('admin/produk/*') ? 'text-white dark:text-white' : 'text-gray-900 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                            d="M14 7h-4v3a1 1 0 0 1-2 0V7H6a1 1 0 0 0-.997.923l-.917 11.924A2 2 0 0 0 6.08 22h11.84a2 2 0 0 0 1.994-2.153l-.917-11.924A1 1 0 0 0 18 7h-2v3a1 1 0 1 1-2 0V7Zm-2-3a2 2 0 0 0-2 2v1H8V6a4 4 0 0 1 8 0v1h-2V6a2 2 0 0 0-2-2Z"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Kelola Produk</span>
                ...
                <ul id="produk-menu" class="hidden py-2 space-y-2">
                    <li>
                        <a href=""
                            class="flex w-full justify-between items-center p-2 pl-11 group rounded-lg {{ request()->routeIs('kategoriProduk.*') ? 'bg-yellow-800 text-white dark:bg-gray-700' : 'text-gray-900 hover:text-white hover:bg-yellow-800 dark:text-white dark:hover:bg-gray-700 group' }}">
                            Kategori
                            <span
                                class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-white bg-yellow-500 rounded-full dark:bg-yellow-900 dark:text-yellow-300">
