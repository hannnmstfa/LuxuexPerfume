<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    class="flex w-full items-center p-2  rounded-lg {{ request()->is('admin/produk/*') ? 'bg-yellow-800 text-white dark:bg-gray-700' : 'text-gray-900 hover:text-white hover:bg-yellow-800 dark:text-white dark:hover:bg-gray-700 group' }}"
