...
class TripayController extends Controller
{
    ...
    public function createTrx($merchantCode, $kodeTrx, $jumlah)
    {
        $data = [
            'method' => $merchantCode,
            ...
            'signature' => hash_hmac('sha256', $this->merchantCode . $kodeTrx . $jumlah, $this->privateKey)
        ];
